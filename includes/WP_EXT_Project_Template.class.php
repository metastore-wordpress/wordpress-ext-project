...
/**
 * Class WP_EXT_Project_Template
 * ------------------------------------------------------------------------------------------------------------------ */

class WP_EXT_Project_Template extends WP_EXT_Project {
 ...
 *
 * @return WP_EXT_Project_Template
 * ------------------------------------------------------------------------------------------------------------------ */

function WP_EXT_Project_Template() {
	static $object;

	if ( null == $object ) {
		$object = new WP_EXT_Project_Template;
	}
...
add_action( 'plugins_loaded', [ WP_EXT_Project_Template(), 'run' ] );
