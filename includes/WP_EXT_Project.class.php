...
class WP_EXT_Project {
	...
	public function __construct() {
		// Settings.
		$this->pt_ID      = 'project';
		$this->archive_ID = 'projects';
		$this->domain_ID  = 'project';
		$this->cap_type   = [ 'pt_project', 'pt_projects' ];
 ...
 *
 * @return WP_EXT_Project
 * ------------------------------------------------------------------------------------------------------------------ */

function WP_EXT_Project() {
	static $object;

	if ( null == $object ) {
		$object = new WP_EXT_Project;
	}
...
add_action( 'plugins_loaded', [ WP_EXT_Project(), 'run' ] );
