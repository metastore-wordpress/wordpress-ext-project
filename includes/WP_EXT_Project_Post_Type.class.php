...
class WP_EXT_Project_Post_Type extends WP_EXT_Project {
	...
	public function post_type() {
		$labels       = [
			...
			'singular_name'         => _x( 'Проект', 'Project Singular Name', 'wp-ext-' . $this->domain_ID ),
			'menu_name'             => __( 'Проекты', 'wp-ext-' . $this->domain_ID ),
			'name_admin_bar'        => __( 'Проект', 'wp-ext-' . $this->domain_ID ),
		...
		$args         = [
			'label'               => __( 'Проект', 'wp-ext-' . $this->domain_ID ),
			'description'         => __( 'Project Description', 'wp-ext-' . $this->domain_ID ),
			'labels'              => $labels,
...
function WP_EXT_Project_Post_Type() {
	...
	if ( null == $object ) {
		$object = new WP_EXT_Project_Post_Type;
	}
